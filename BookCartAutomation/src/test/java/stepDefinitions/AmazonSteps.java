...
public class AmazonSteps {
    ...
    public AmazonSteps() {
        this.driver = DriverFactory.getDriver(); // Ensure driver is initialized
        this.searchResultsPage = new AmazonSearchResultsPage(driver); // Initialize this
        this.cartPage = new AmazonCartPage(driver);
    }

    @And("I add the first 5 items to the cart")
    public void addProductsToCart() {
        searchResultsPage.addFirstFiveProductsToCart(); // ❌ Failing before due to null object
    }
